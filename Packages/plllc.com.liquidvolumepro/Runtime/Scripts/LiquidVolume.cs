...
namespace LiquidVolumeFX {
    ...
    public partial class LiquidVolume : MonoBehaviour {
        ...
        public void OnWillRenderObject() {
            RenderObject();
            liqMat.SetVector("_CustomWorldSpaceCameraPos", Camera.current.transform.position);
        }
        ...
        void UpdateBubblesProperties() {
            ...
            liqMat.SetVector("_BubblesData", new Vector3(100f / (1f + _bubblesScale), bubblesVerticalSpeedAcum, _bubblesBrightness));
        }
        ...
        void UpdateLightEffects() {
            ...
            if (liqMat != null) {
                liqMat.SetFloat("_PointLightInsideAtten", pointLightInsideAtten);
        ...
        void RefreshMaterialProperties() {
            ...
            liqMat.SetFloat("_BackDepthBias", -_backDepthBias);
            ...
            liqMat.SetColor("_FlaskColor", _flaskColor);
            ...
            switch (_detail) {
                case DETAIL.BumpTexture:
                    ...
                    liqMat.SetFloat("_BumpStrength", _bumpStrength);
            ...
            if (_noiseVariation != currentNoiseVariation || requireBubblesUpdate) {
                ...
                if (noise3DTex[currentNoiseVariation] == null) {
                    ...
                    noise3DTex[currentNoiseVariation].hideFlags = HideFlags.DontSave;
                }
        ...
        void UpdateLevels(bool updateShaderKeywords = true) {
            ...
            if (_detail.isMultiple()) {
                liqMat.SetFloat("_SizeWorld", mr.bounds.size.y);
            }
